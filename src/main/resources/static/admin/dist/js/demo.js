...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('Admin:MessageShowed')) < Date.now()) {
      localStorage.setItem('Admin:MessageShowed', (Date.now()) + (15 * 60 * 1000))
      // eslint-disable-next-line no-alert
      alert('Chào Mừng Bạn \'s Đến Với, \n "Bình Nguyên Vô Tận" !!!')
    }
  }, 1000)
